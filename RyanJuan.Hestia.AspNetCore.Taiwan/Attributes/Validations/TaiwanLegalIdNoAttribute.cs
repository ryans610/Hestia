...
namespace RyanJuan.Hestia.AspNetCore.Taiwan.Attributes.Validations;
...
public class TaiwanLegalIdNoAttribute() :
    ValidationAttribute(() => "The value for {0} must be a valid Taiwan LegalId."),
    IClientModelValidator
{
    ...
    public void AddValidation(ClientModelValidationContext context)
    {
        ...
        context.Attributes.TryAdd("data-val-taiwanLegalIdNo",
