...
public class LessThanAttribute : CompareValueAttributeBase, IClientModelValidator
{
    private const string DefaultErrorMessage = "The value for {0} must be less than {1}.";
    ...
    /// by the <c>type</c> parameter of the <see cref="LessThanAttribute(Type, string)"/> constructor are carried
    ...
    public void AddValidation(ClientModelValidationContext context)
    {
        ...
        context.Attributes.TryAdd("data-val-lessThan", FormatErrorMessage(context.ModelMetadata.GetDisplayName()));
        ...
        context.Attributes.TryAdd("data-val-lessThan-compareValue", stringCompareValue);
    }
}
